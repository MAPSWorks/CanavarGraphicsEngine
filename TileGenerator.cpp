...
TileGenerator::TileGenerator(int resolution, int tiles, float width, QObject *parent)
    : QObject{parent}
...
QVector2D TileGenerator::whichTile(const QVector3D &subject) const
{
...
void TileGenerator::translateTiles(const QVector2D &translation)
{
